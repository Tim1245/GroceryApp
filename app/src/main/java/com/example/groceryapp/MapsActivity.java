...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Location icaValsvikenLoc=new Location("Ica Valsviken");
        ...
        Location lidlLoc=new Location("Lidl Våxnäs");
        lidlLoc.setLatitude(59.38695327943067);
        lidlLoc.setLongitude(13.47556768120986);

        locations.add(coopBergvikLoc);
        locations.add(icaValsvikenLoc);
        locations.add(willysCityLoc);
        locations.add(lidlLoc);
        ...
        LatLng lidl = new LatLng(59.38695327943067, 13.47556768120986);
        ...
        mMap.addMarker(new MarkerOptions().position(lidl).title("Lidl Våxnäs"));
